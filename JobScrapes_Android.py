...
if strdate == '1':
	...
	sql = "DROP TABLE IF EXISTS JobPostings_Android"
	mycursor.execute(sql) 

paramlist = ["Data%20Engineer","AWS%20Engineer","Big%20Data%20Engineer","Hadoop%20Engineer","Spark%20Engineer"]

try:
	df = pd.read_sql_table('JobPostings_Android', database_connection)
	if 'level_0' in df:
	...
	for searchval in paramlist:
		...
		df.to_sql(con=database_connection, name='JobPostings_Android', if_exists='replace')
